...
Secktor.cmd({
        ...
        async(Void, citel, text) => {
            ...
            if (text.split(" ")[0]) {
                ...
                evil arr.push(`*🍁Command:* ${cmd.pattern}`);
...
*✦*`
                str += `*│· • • ━ ⊰✨⊱ ━ • • ·│*
*┇اهـلاً بـك فـي أوامـر الـبـوت "ايفيل" ✨┇*

* اسـم الـبـوتـه 🤖 ⦂『ايفيل』*
* وقـت الـعـمـل 🕑 ⦂『 ${runtime(process.uptime())} 』*
* الـمـطـوريـن 🧑🏻‍💻 ⦂ 『ايــفيل مــومــيا الشبــراوي$』*
* اصـدار 📲 ⦂『v2』*
* الـمـنـصـة 🌐 ⦂『هـيـروكـو』*

* الـمـوقـع الـرسـمـي لـلـبـوت 🔗 『https://639cdc98e060b.site123.me/ 』*

* أرقـام الـمـطـوريـن 👨‍💻 ⦂『+201153396489』*

*│· • • ━ ⊰✨⊱ ━ • • ·│💘*

*⤺┇.1.1↜〘قسـم الاعـضـاء〙*
*⤺┇.2.1↜〘قسـم الـمـطـور〙*
*⤺┇.3.1↜〘قسـم الـقـروبـات〙*
*⤺┇.4.1↜〘قسـم الـتـحمـيـل〙*
*⤺┇.5.1↜〘قـسـم الالـعـاب〙*
*⤺┇.6.1↜〘قـسـم الـتحـويـل〙*
*⤺┇.7.1↜〘قـسـم الانـمي〙*
*⤺┇.8.1↜〘قـسـم البـنـك〙*
*⤺┇.9.1↜〘كـل الاوامـر〙*
